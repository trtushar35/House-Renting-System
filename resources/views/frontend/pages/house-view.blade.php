                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="d-flex flex-row align-items-center"> <i class='fa fa-apple fs-1'></i>
                         <span class="fw-bold ms-1 fs-5">{{$singleHouse->house_name}}</span> </div>
                        <h1 class="fs-1 ms-1 mt-3">{{$singleHouse->house_address}}</h1>
                    ...
                    <div class="col-md-6">
                        <div class="product-image"> <img src="{{url('/uploads/'.$singleHouse->image)}}"> </div>
                    </div>
                </div>
            </div>
        </div>
